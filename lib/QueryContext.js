(function() {
    ...
    const keywordDebug = !!process.argv.filter(item => item .startsWith('--related-keywords=')).length;
    ...
    module.exports = new Class({
        ...
        , init: function(queryDefinition) {
            ...
            if (keywordDebug) {
                const len = Error.stackTraceLimit;
                Error.stackTraceLimit = 10000;
                this.stack = new Error('sql debugger stack capture').stack;
                Error.stackTraceLimit = len;
            }
